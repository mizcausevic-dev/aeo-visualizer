...
### Released
- Published **aeo-visualizer** as a public, portfolio-grade answer-engine visibility system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **aeo-visualizer**.
...
- That insight became the basis for **aeo-visualizer**.
